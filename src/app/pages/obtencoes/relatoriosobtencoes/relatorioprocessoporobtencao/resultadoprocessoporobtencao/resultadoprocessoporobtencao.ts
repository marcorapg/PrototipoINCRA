...
@Component({
  selector: 'app-resultadoprocessoporobtencao',
  imports: [Relatoriocabecalho],
  templateUrl: './resultadoprocessoporobtencao.html',
  styleUrl: './resultadoprocessoporobtencao.css',
})
export class Resultadoprocessoporobtencao implements AfterViewInit {
